...
(function() {
    ...
    if (window.mw && window.mw.loader) {
        ...
        console.log('[ENHANCED-EXECUTOR] Saved originalUsing:', typeof originalUsing);
        ...
        window.mw.loader.using = function(dependencies, ready, error) {
            ...
            // No URL modules, use original or create basic implementation
            ...
            if (originalUsing && typeof originalUsing === 'function') {
                ...
                console.warn('[ENHANCED-EXECUTOR] originalUsing not available, creating basic implementation');
