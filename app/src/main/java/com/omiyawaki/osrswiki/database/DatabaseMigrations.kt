...
object DatabaseMigrations {
    ...
    val MIGRATION_7_8: Migration = object : Migration(7, 8) {
        override fun migrate(database: SupportSQLiteDatabase) {
            ...
            """.trimIndent())
            database.execSQL("CREATE UNIQUE INDEX IF NOT EXISTS `index_offline_objects_url_lang` ON `offline_objects` (`url`, `lang`)")
        }
    }
    ...
    val MIGRATION_9_10 = object : Migration(9, 10) {
        override fun migrate(database: SupportSQLiteDatabase) {
            ...
            android.util.Log.i("DBMigration", "Migrating database from version 9 to 10. Created FTS table 'offline_page_fts'.")
        }
    }
    ...
    val MIGRATION_10_11 = object : Migration(10, 11) {
        override fun migrate(database: SupportSQLiteDatabase) {
            ...
            """.trimIndent())
            android.util.Log.i("DBMigration", "Migrating database from version 10 to 11. Created history_entries table.")
        }
    }
