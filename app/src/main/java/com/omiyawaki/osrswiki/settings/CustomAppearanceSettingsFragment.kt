...
class CustomAppearanceSettingsFragment : Fragment(), ThemeAware {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        L.d("APPEARANCE_TIMING: CustomAppearanceSettingsFragment.onViewCreated() started at ${fragmentStartTime}")
        ...
        val fragmentDuration = System.currentTimeMillis() - fragmentStartTime
        L.d("APPEARANCE_TIMING: CustomAppearanceSettingsFragment.onViewCreated() completed in ${fragmentDuration}ms total")
