...
class SpeechRecognitionManager(
    ...
    private val speechGateway: SpeechRecognitionGateway = SpeechRecognitionGatewayRegistry.gateway
) {
    ...
    private var speechRecognizer: SpeechRecognitionHandle? = null
    ...
    fun startVoiceRecognition() {
        ...
        when {
            !speechGateway.isRecognitionAvailable(context) -> {
    ...
    private fun startListening() {
        ...
        try {
            ...
            speechRecognizer = speechGateway.createRecognizer(context, recognitionListener)
