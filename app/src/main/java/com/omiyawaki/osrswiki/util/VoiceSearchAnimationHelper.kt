...
class VoiceSearchAnimationHelper(private val voiceButton: ImageView) {
    ...
    private val idleContentDescription: CharSequence =
        voiceButton.contentDescription ?: voiceButton.context.getString(R.string.search_hint_voice_search)
    ...
    fun setIdleState() {
        ...
        voiceButton.contentDescription = idleContentDescription
    }
    
    fun setListeningState() {
        stopCurrentAnimation()
        voiceButton.contentDescription = voiceButton.context.getString(R.string.voice_search_listening_description)
    ...
    fun setProcessingState() {
        stopCurrentAnimation()
        voiceButton.contentDescription = voiceButton.context.getString(R.string.voice_search_processing_description)
    ...
    fun setErrorState() {
        stopCurrentAnimation()
        voiceButton.setImageResource(R.drawable.ic_voice_search_24)
        voiceButton.contentDescription = voiceButton.context.getString(R.string.voice_search_error_description)
