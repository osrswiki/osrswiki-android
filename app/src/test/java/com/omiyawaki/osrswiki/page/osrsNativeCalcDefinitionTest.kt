...
class osrsNativeCalcDefinitionTest {
    ...
    fun nativeChromeIsKitNotTitleAndFallsBackOnUnknownTypes() {
        ...
        assertTrue(osrsNativeCalcDefinition.isPageNativeChromeEligible(coordinates, "Calculator:Coordinates"))
        ...
        val mixed = coordinates.replace("int | 0-180", "voiceofseren |")
        assertFalse(osrsNativeCalcDefinition.isPageNativeChromeEligible(mixed, "Calculator:Coordinates"))
