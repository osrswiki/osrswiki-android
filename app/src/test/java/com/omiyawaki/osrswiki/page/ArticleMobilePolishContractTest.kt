...
class ArticleMobilePolishContractTest {
    ...
    fun rendererClassifiesInlinePortraitVignetteAndScrollableContent() {
        ...
        assertTrue(script.contains("markTocLayoutTables"))
        assertTrue(script.contains("osrs-toc-layout-table"))
        assertTrue(script.contains("osrs-toc-layout-host"))
        assertTrue(script.contains("setProperty('width', 'fit-content', 'important')"))
        assertTrue(css.contains("display: table !important"))
        assertTrue(css.contains("width: auto !important"))
        assertTrue(script.contains("expandProseBanners"))
        assertTrue(script.contains("table.archivelist"))
        assertTrue(css.contains("#toctemplate"))
        assertTrue(css.contains("osrs-toc-layout-host"))
